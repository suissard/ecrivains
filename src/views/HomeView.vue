  ...
  <div class="bg-gray-100 text-gray-800 font-sans min-h-screen p-4 md:p-8 relative">
    ...
    <div v-if="isSettingsOpen" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-xl shadow-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div class="mb-6 flex justify-between items-center bg-indigo-50 p-4 rounded-lg">
          <div>
            <h4 class="font-bold text-indigo-800">Besoin d'aide ?</h4>
            <p class="text-sm text-indigo-600">Découvrez comment utiliser l'application étape par étape.</p>
          </div>
          <router-link to="/tutorial" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-lg shadow-sm transition-colors text-sm flex items-center gap-2">
